        ...
        <div className="header" id="home">
            <div className="container">
                <ul>
                    ...
                    <li> 
                    <Link to={routes.signup} ><i className="fa fa-unlock-alt" aria-hidden="true"></i> Sign In </Link>
                        <a href="#" data-toggle="modal" data-target="#myModal2"><i className="fa fa-pencil-square-o" aria-hidden="true"></i> Sign Up </a>
                        </li>
