      ...
      <Container component="main" maxWidth="xs">
        ...
        <div className={classes.paper}>
          ...
          <form onSubmit={(e) => onFormSubmitHandler(e)} className={classes.form} noValidate>
            <TextField variant="outlined" margin="normal" required fullWidth id="email" label="Email Address" name="email" autoComplete="email" onChange={(e) => onChangeHandler(e, 'email')} autoFocus />
            <TextField variant="outlined" margin="normal" required fullWidth name="password" label="Password" onChange={(e) => onChangeHandler(e, 'password')} type="password" id="password" autoComplete="current-password" />
            <FormControlLabel
