...
const mapDispatchToProps = (dispatch) => {
  return {
    onSignInInit: (mapStateToProps,formData) => dispatch(actionsList.authSignInInit(formData))
  }

}

export default connect(null, mapDispatchToProps)(withErrorHoc(SignIn, axios))