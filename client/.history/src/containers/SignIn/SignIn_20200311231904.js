...
const SignIn = () => {
  ...
  const onChangeHandler = (event, identifier) => {
    console.log(identifier, stateData)

    const updatedElement = updateObject(stateData.signInForm[identifier],{
      value : event.target.value
    })
    const updatedForm = updateObject(stateData.signInForm, {
      [identifier] : updatedElement
    })
    console.log(updatedForm)
    const updatedState = updateObject(stateData, {
      signInForm : updatedElement
    })


    // const updatedState = { ...stateData }
    // const updatedForm = { ...stateData.signInForm }
    // const updatedElement = { ...updatedForm[identifier] }
    // updatedElement.value = event.target.value
    // updatedForm[identifier] = updatedElement
    // updatedState.signInForm = updatedForm
